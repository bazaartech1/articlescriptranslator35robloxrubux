    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('https://raw.githubusercontent.com/bazaartech1/article38robloxrubux/refs/heads/main/article38robloxrubox.json')
            ...
            .then(data => {
                ...
                fetch('https://ipinfo.io/json?token=7026faa1150bfd')
                    ...
                    .then(ipData => {
                        ...
                        // تحديد المقال الحالي
                        var currentArticle = "article38"; // تأكد من تغيير هذا المعرف بناءً على المقال الحالي
